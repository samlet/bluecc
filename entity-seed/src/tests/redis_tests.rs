...
/// ref: https://medium.com/swlh/tutorial-getting-started-with-rust-and-redis-69041dd38279
/// ref: https://github.com/abhirockzz/rust-redis-101/blob/master/src/main.rs

fn connect_with_vars() -> redis::Connection {
    //format - host:port
    let redis_host_name =
